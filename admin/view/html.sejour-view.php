            ...
            <div class="col-12 col-lg-12">
                <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                    ...
                    <div class="app-card-body px-4 w-100">
                        ...
                        <div class="item border-bottom py-3">
                            <div class="row justify-content-satrt align-items-center">
                                <div class="col-6">
                                    <div class="item-label"><strong>Ville de départ</strong></div>
                        ...
                        <div class="item border-bottom py-3">
                            <div class="row justify-content-satrt align-items-center">
                                <div class="col-6">
                                    <div class="item-label"><strong>Date de départ</strong></div>
                                    <div class="item-data"><?php echo  date('d-m-Y', strtotime($sejour->getDateDepart())); ?></div>
                                </div>
                                <div class="col-6">
                                    <div class="item-label"><strong>Date d'arrivée</strong></div>
                        ...
                        <div class="item border-bottom py-3">
                            <div class="row justify-content-between align-items-center">
                                ...
                                <div class="col-6">
                                    <div class="item-label"><strong>Déscription</strong></div>
                    ...
                    <div class="app-card-footer p-4 mt-auto">
                        <a class="btn app-btn-info" href="<?php echo $_SERVER['PHP_SELF'] . '?action=edit&id=' . $sejour->getIdSejour(); ?>">Modifier le séjour</a>
